...
function SWEP:PrimaryAttack()
	...
	if self.Drag then
		...
		if not IsValid( HitEnt ) or HitEnt:GetMoveType() ~= MOVETYPE_VPHYSICS or
			...
			HitEnt:GetClass() == "sent_bm-21_p" or
			HitEnt:GetClass() == "sent_bmp-2_p" or
			HitEnt:GetClass() == "sent_btr-80_p" or
			HitEnt:GetClass() == "sent_bulldozer_p" or
			HitEnt:GetClass() == "sent_scud_p" or
			HitEnt:GetClass() == "sent_t-62a_p" or
			HitEnt:GetClass() == "sent_t-72_2_p" or
			HitEnt:GetClass() == "sent_t-72_p" or
			HitEnt:GetClass() == "sent_t-80bv_p" or
			HitEnt:GetClass() == "sent_sprut" or

			HitEnt:GetClass():find("lfs") or
			HitEnt:GetClass():find("rebelheli") or
